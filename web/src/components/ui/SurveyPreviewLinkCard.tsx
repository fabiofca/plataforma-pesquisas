...
export function SurveyPreviewLinkCard({ surveyId, isDraft }: SurveyPreviewLinkCardProps) {
  ...
  return (
    <div className="border border-sky-200 bg-[linear-gradient(180deg,#f8fdff_0%,#eef8ff_100%)] p-4 shadow-card" style={{ borderRadius: 6 }}>
      ...
      {previewUrl ? (
        <div className="mt-4 border border-sky-200 bg-white p-4" style={{ borderRadius: 6 }}>
      ...
      {feedback ? (
        <div className="mt-4 border border-sky-200 bg-sky-50 px-4 py-3 text-sm text-sky-900" style={{ borderRadius: 6 }}>
          {feedback}
        </div>
      ) : null}
    </div>
